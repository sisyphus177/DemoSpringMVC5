 ...
 *
 */
@Service("accountServiceHibernateImpl")
public class AccountServiceHibernateImpl implements AccountService {

    private AccountDao accountDao;

    @Resource(name = "accountDaoHibernateImpl")
...
//            System.out.println("AccountServiceHibernateImpl");
